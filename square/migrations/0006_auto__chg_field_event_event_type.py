...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'square_event', 'event_type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Event.event_type'
        db.alter_column(u'square_event', 'event_type', self.gf('django.db.models.fields.CharField')(max_length=2))
