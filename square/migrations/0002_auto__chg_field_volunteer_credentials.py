...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Volunteer.credentials'
        db.alter_column(u'square_volunteer', 'credentials', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'square.event': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 26, 0, 0)'}),
        ...
        u'square.volunteer': {
            ...
            'credentials': ('django.db.models.fields.CharField', [], {'default': "'Volunteer'", 'max_length': '20', 'blank': 'True'}),
            ...
            'signup_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 26, 0, 0)'}),
