...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Volunteer.hours'
        db.delete_column(u'square_volunteer', 'hours')
        ...
        db.alter_column(u'square_volunteer', 'credentials', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Adding field 'Volunteer.hours'
        db.add_column(u'square_volunteer', 'hours',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, max_length=20),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'Volunteer.credentials'
        raise RuntimeError("Cannot reverse this migration. 'Volunteer.credentials' and its values cannot be restored.")
    ...
    models = {
        ...
        u'square.event': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)'}),
        ...
        u'square.volunteer': {
            ...
            'credentials': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'signup_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)'}),
