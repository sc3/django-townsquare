...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'square_volunteer', 'credit', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Volunteer.credit'
        db.alter_column(u'square_volunteer', 'credit', self.gf('django.db.models.fields.CharField')(max_length=7))
